    ...
    <Container>
        <div className="mb-10">
            <div className="flex items-center justify-between">
                ...
                <Link 
                to={"/category/tvAndAudi"}
                className="font-medium relative group overflow-hidden"
                >
                    View All categories{" "}
                    <span className="absolute bottom-0 left-0
                    w-full block h-[1px] bg-gray-600 -translate-x-[100%]
                    group-hover:translate-x-0 duration-300"></span>
                </Link>
            </div>
            <div className="w-full h-[1px] bg-gray-200 mt-3"/>
        </div>
        <div className="grid grid-cols-3 md:grid-col-4 lg:grid-cols-6 gap-7">
